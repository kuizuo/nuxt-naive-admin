...
export interface TableRowSelection<T = any> extends DataTableBaseColumn {
  /**
...
export interface TableCustomRecord<T = Record<string, any>> {
  record?: T
  index?: number
}
...
export interface TableActionType {
  ...
  setTableData: <T = Record<string, any>>(values: T[]) => void
  updateTableDataRecord: (rowKey: string | number, record: Record<string, any>) => Record<string, any> | void
  deleteTableDataRecord: (rowKey: string | number | string[] | number[]) => void
  insertTableDataRecord: (record: Record<string, any>, index?: number) => Record<string, any> | void
  findTableDataRecord: (rowKey: string | number) => Record<string, any> | void
  getColumns: (opt?: GetColumnsParams) => BasicColumn[]
  setColumns: (columns: BasicColumn[] | string[]) => void
  getDataSource: <T = Record<string, any>>() => T[]
  getRawDataSource: <T = Record<string, any>>() => T
  ...
  emits?: EmitType
  updateTableData: (index: number, key: string, value: any) => Record<string, any>
  setShowPagination: (show: boolean) => Promise<void>
  getShowPagination: () => boolean
  setCacheColumnsByField?: (key: string | undefined, value: Partial<BasicColumn>) => void
}
...
export interface BasicTableProps<T = any> {
  ...
  // 排序方法
  filterFn?: (data: Partial<Record<string, string[]>>) => any
  // 取消表格的默认padding
  inset?: boolean
  // 显示表格设置
  ...
  // 计算合计行的方法
  summaryFunc?: (...arg: any) => Record<string, any>[]
  // 自定义合计表格内容
   ...
   */
  title?: VNodeChild | JSX.Element | string | ((data: Record<string, any>) => string)

  /**
   * Set props on per header row
   * @type Function
   */
  customHeaderRow?: (column: DataTableBaseColumn, index: number) => object
